...
$admin_pswd='adminpass123'; //backend password 
...
$row_username='UserId'; //specifies the name of the field in which the user's name/display name is stored.
