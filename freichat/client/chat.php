            ...
            <script type="text/javascript">
                ...
                function fill_room_data() {
                    ...
                    for (var i = 0; i < len; i++) {
                        ...
                        wrapper += "<li class='users_li rooms_li' \n\
                                    onclick=\"FreiChat.open_panel('" + mobile.room_array[i].room_name + "','" + mobile.room_array[i].room_id + "','chatroom')\" class=\"freichat_userlist\" \n\
                                    ><div> \n\
                                    <div class=\"freichat_userscontentname no-padding\">" + mobile.room_array[i].room_name + "</div>\n\
                                    <div class='new_messages_no' id='room_new_messages_" + mobile.room_array[i].room_id + "'>" + mobile.room_array[i].online_count + "</div>\n\
                                    </div></li>";

                    }

                    FreiChat.divrooms.html(wrapper).listview("refresh");
                };
