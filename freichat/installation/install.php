    ...
    <div class="box-content" >
        <span  style="">
            ...
            <div id ="manual" class="well">
                ...
                <a style="text-align:center"class="btn" href="javascript:void(0)"onmousedown="maximize()"><i class="icon-pencil"></i> get the code</a>
                <span id ="content_manual">
                    ...
                    <br/>
                    <textarea style="width:100%;font-size:12pt" class="resizable" rows="8" cols="95" onclick="this.focus();this.select()" readonly="readonly">
                        <?php echo $info['phpcode']; ?>
        ...
        <?php } ?><br/><br/><div align='center'>
            <a style="width:200px" class="btn btn-primary" href='../administrator/index.php' target="_blank"><i class="icon-wrench icon-white"></i> Administer</a>
        </div><br/><br/>
    </div>
