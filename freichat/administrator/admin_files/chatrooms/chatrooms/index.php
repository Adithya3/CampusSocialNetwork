...
<div class="row-fluid sortable ui-sortable">		
    <div class="box span12">
        ...
        <div class="box-content">
            <form action="admin.php?freiload=chatrooms/chatrooms&do=create" method="post">

                <div class="control-group">
                    <label class="control-label" for="focusedInput"> Name:</label>
                    <div class="controls">
                        <input type="text" name="room_name" placeholder="chatroom name" /></div> 
                </div>

                <div class="control-group">
                    <label class="control-label" for="focusedInput"> Order:</label>
                    <div class="controls">
                        <input type="text" name="room_order" placeholder="1" value="1" /></div> 
                </div>
            ...
            <table class="table table-striped table-bordered bootstrap-datatable datatable dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                ...
                <tbody role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    foreach ($result as $res) {
                        ...
                        echo "<td><a onmousedown='editroom(" . $res['id'] . ",\"rname" . $i . "\",\"rorder" . $i . "\")' class='btn btn-info' href='#'>
...
<div id="editroom" class="modal hide fade" tabindex="-1" data-width="760">
    ...
    <div class="modal-body">
        ...
        <form action="admin.php?freiload=chatrooms/chatrooms&do=edit" method="post">
            ...
            <button onclick="$('#editroom').modal('hide');return false" id="paramsubmit4" class="btn" > Cancel</button>
