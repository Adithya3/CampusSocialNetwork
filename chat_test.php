...
<div id="chat_widget_container">
    <div id="chat_widget_login">
        ...
        <img src="https://media.giphy.com/media/3oEjI6SIIHBdRxXI40/giphy.gif" alt="Logging in..." id="chat_widget_login_loader" />
    </div>
    ...
    <div id="chat_widget_main_container">
        ...
        <div id="chat_widget_input_container">
            <form method="post" id="chat_widget_form">
                ...
                <img src="https://media.giphy.com/media/3oEjI6SIIHBdRxXI40/giphy.gif" alt="Sending..." id="chat_widget_loader" />
            </form>
        </div>
    </div>
</div>
