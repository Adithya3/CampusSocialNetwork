...
<head>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var active_student=<?php echo
            mysqli_num_rows(mysqli_query($conn,"SELECT  * FROM ".$_SESSION['table_name']." where Active='yes' and Role='student'" ));
            ?>;

            var pending_student=<?php echo
                    mysqli_num_rows(mysqli_query($conn,"SELECT  * FROM ".$_SESSION['table_name']." where Active='no' and Role='student'" ));
                    ?>;
            var active_teacher=<?php echo
                mysqli_num_rows(mysqli_query($conn,"SELECT  * FROM ".$_SESSION['table_name']." where Active='yes' and Role='teacher'" ));
                ?>;

            var pending_teacher=<?php echo
                mysqli_num_rows(mysqli_query($conn,"SELECT  * FROM ".$_SESSION['table_name']." where Active='no' and Role='teacher'" ));
                ?>;

            var data = google.visualization.arrayToDataTable([
                ['status', 'no.'],
                ['Approved',     active_student],
                ['Pending',      pending_student]
            ]);
            var data2 = google.visualization.arrayToDataTable([
                ['status', 'no.'],
                ['Approved',     active_teacher],
                ['Pending',      pending_teacher]
            ]);
            ...
            var chart2 = new google.visualization.PieChart(document.getElementById('Teacherpichart'));
...
if(isset($_POST['username'])) {
    ...
    $sql = "UPDATE ".$table."  SET `Active`='yes' WHERE `Username`='" . $username . "'";
    ...
    <main class="mdl-layout__content mdl-color--grey-100">
        <div class="mdl-grid demo-content">
            <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
                <div id="Studentpiechart" style="width: 50%;height: 100%;"></div>
                <div id="Teacherpichart" style="width: 50%;height: 100%;"></div>
            </div>

            <div class="demo-graphs mdl-shadow--2dp mdl-color--white mdl-cell mdl-cell--12-col">
                <div class="container-fluid ">
                    <h2 id="forClearing">Approved Users</h2>
                    <div class="pip" style="width: 1000px; height: 400px; overflow: scroll">
                        <table id="approvedusers" class="table table-striped table-hover scroll">
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM ".$_SESSION['table_name']." where Active='yes' ";
                ...
                <div class="container-fluid">
                    ...
                    <div class="pip" style="width: 1000px; height: 400px; overflow: scroll">
                        <table id="upapprovedusers" class="table table-striped table-hover">
                            ...
                            <?php
                            $ip="ComputerEngineeringStudentTeacher";
                            $sql = "SELECT * FROM ".$_SESSION['table_name']." where Active='no' ";
                            $result=mysqli_query($conn,$sql);
                            if($result === false) {
                            ...
                            while($row=mysqli_fetch_array($result)) {
                                ...
                                echo "<td id=\"Contact_No.\">".$row['Contact']."</td>";
                                echo "<td id=\"Role\">".$row['Role']."</td>";
                                echo "<td><div style=\"width: 50%; height: 50%; float:left;\"><button class=\"btn btn-default btn-xs approve-btn\">  <i class=\"glyphicon glyphicon-ok\"></i></button></div><div style=\"width: 50%; height: 50%; float:right;\"><button class=\"btn btn-default btn-xs remove-btn\">  <i class=\"glyphicon glyphicon-remove\"></i></button></div></td>";
                                echo "</tr>";
                            }
                            ?>
                            </tbody>
