<head>
    <script src="http://js.pusherapp.com/2.2/pusher.min.js"></script>
...
<script type="text/javascript">
    ...
    $('body').on('click', '.chat_box .input_send', function(e) {
        ...
        if (name === '') {
            ...
            $('.input_send_holder').html('<input type = "submit" value = "Send" class = "btn btn-primary" disabled /> &nbsp;<img src = "https://media.giphy.com/media/3oEjI6SIIHBdRxXI40/giphy.gif" />');
        }
    });
